package com.san.ipassmanager.services
...
class DriveHelper(private val mDriveService: Drive) {
     ...
     */
    fun createFile(fileName: String, mimeType: String): Task<String> {
     ...
     * contents.
     */
    fun readFile(fileId: String?, fileName: String?): Task<Pair<String, String>> {
        return Tasks.call(mExecutor,
            {
                ...
                val name = fileName ?: metadata.name
 ...
 * Developer's Console](https://play.google.com/apps/publish) and be submitted to Google for verification.
    ...
    fun createNewFile(name: String?, mimeType: String): Task<String> {
        return Tasks.call(mExecutor, {
            val metadata =
                File()
